...
print("Welcome to the DIDDY GAME!")
print("You have stolen a UFO to make your way across outer space. The diddlers want their UFO back and are chasing you down!")
print("Survive and out run the diddlers!")
